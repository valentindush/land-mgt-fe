    ...
    <form @submit.prevent="onSubmit" class="bg-white shadow-lg rounded-xl px-8 pt-8 pb-8 mb-4 border border-gray-100">
      ...
      <div class="mb-6">
        ...
        <div class="relative">
          ...
          <input
            ...
            :class="{
              'border-red-500 bg-red-50 focus:border-red-500 focus:ring-red-500': errors.fullName,
              'border-green-500 bg-green-50': fullName && !errors.fullName
            }"
            placeholder="John Doe"
            aria-describedby="fullName-error"
          />
          <div v-if="errors.fullName" class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            </svg>
          </div>
          <div v-else-if="fullName" class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <svg class="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
            </svg>
          </div>
        </div>
        <p v-if="errors.fullName" id="fullName-error" class="mt-2 text-sm text-red-600 flex items-center">
      ...
      <div class="mb-8">
        ...
        <div class="relative">
          ...
          <input
            ...
            class="pl-10 pr-4 py-3 w-full rounded-lg border-gray-300 bg-gray-50 text-gray-900 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-30 transition duration-150 ease-in-out"
            :class="{
              'border-red-500 bg-red-50 focus:border-red-500 focus:ring-red-500': errors.confirmPassword,
              'border-green-500 bg-green-50': confirmPassword && password === confirmPassword && !errors.confirmPassword
            }"
            placeholder="••••••••"
            aria-describedby="confirmPassword-error"
          />
          <div v-if="errors.confirmPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            </svg>
          </div>
          <div v-else-if="confirmPassword && password === confirmPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <svg class="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
            </svg>
          </div>
        </div>
        <p v-if="errors.confirmPassword" id="confirmPassword-error" class="mt-2 text-sm text-red-600 flex items-center">
          <svg class="h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
          </svg>
      ...
      <div class="text-center mt-6">
        <p class="text-sm text-gray-600">
          ...
          <router-link to="/login" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-150">
            Sign in
          </router-link>
        </p>
      </div>
